...
/**
 ...
 | ___ \ . ` || ___ \ | __ / _ \ '_ ` _ \ 
 | |_/ / |\  || |_/ / |_\ \  __/ | | | | |
 \____/\_| \_/\____/ \____/\___|_| |_| |_| Established 2021 

 Website: https://bnbgem.com
 Twitter: @BNBGem_BSC
 Email: support@bnbgem.com
 Github: https://github.com/BNBGem
 Telegram: https://t.me/BNB_GEM
*/
...
contract BNBGem is Context, IERC20, Ownable {
    ...
    string private _name = "BNB Gem";
    string private _symbol = "BNBG";
    ...
    address public marketingWallet = 0x6eA651D1B9a703031465CAe6eCae3efABfC393e0;
    ...
    // Run enableDefaultFees() after presale. This functions is to control fees overtime. Supply > Demand = Low Fees | Supply < Demand = High Fees
    function enableDefaultFees() external onlyOwner() {
        _taxFee = 4;
    ...
    function enableHighFees() external onlyOwner() {
        _taxFee = 5;
        _previousTaxFee = _taxFee;
        _liquidityFee = 3;
        _previousLiquidityFee = _liquidityFee;
    ...
    // Enable GEM BURNING (ONLY OWNER)
    function enableBurn_1() external onlyOwner() {
        _burnFee = 1;
        _previousBurnFee = _burnFee;
    }

    function enableBurn_2() external onlyOwner() {
        _burnFee = 2;
        _previousBurnFee = _burnFee;
    }

    function enableBurn_3() external onlyOwner() {
        _burnFee = 3;
        _previousBurnFee = _burnFee;
    }

    function enableBurn_4() external onlyOwner() {
        _burnFee = 4;
        _previousBurnFee = _burnFee;
    }
